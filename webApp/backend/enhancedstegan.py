...
if __name__ == "__main__":
    def find_best_model(models_dir='results/model'): # tìm model tốt nhất trong thư mục
    ...
    if MODEL_PATH:
        print(f"Sử dụng model tốt nhất: {MODEL_PATH}")
    else:
        print("Không tìm thấy model trong results/model; hãy đặt MODEL_PATH thủ công nếu cần")
    ...
    print("\n=== HOÀN THÀNH ===")
    print("Ảnh cover gốc → Stego (với message ẩn)")
    print("Stego → Message đã giải mã")
    print("Stego → Ảnh cover đã khôi phục (reverse hiding)")